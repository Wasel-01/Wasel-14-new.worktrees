    ...
    <div className="container mx-auto py-8 px-4 space-y-8 max-w-5xl">
      <div className="flex flex-col md:flex-row gap-8 items-start">
        ...
        <div className="flex-1 w-full space-y-6">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Wassel Delivery</h1>
                ...
                <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                  <div className="flex gap-3">
                    ...
                    <div className="space-y-2 text-sm">
                      <p className="font-medium text-blue-900 dark:text-blue-100">Why choose Wassel Delivery?</p>
                 ...
                 <Card key={res.id} className="hover:shadow-md transition-shadow">
                   <CardContent className="flex items-center justify-between p-6">
                      ...
                      <div className="text-right">
                        <div className="text-2xl font-bold text-primary">AED {res.price}</div>
               ...
               <CardContent className="space-y-6">
                 <div className="bg-muted/30 p-4 rounded-lg space-y-2">
                    ...
                    <div className="flex justify-between text-lg font-bold">
                      <span>Total:</span>
                      <span>AED {selectedDriver.price}</span>
                    </div>
                 </div>
                 <div className="space-y-2">
          ...
          <Card className="border-2 border-primary/20 shadow-lg">
            ...
            <CardContent className="space-y-5 pt-6">
              ...
              <div className="space-y-3 p-4 bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg">
                ...
                <div className="space-y-1.5 text-sm">
                  <div className="flex items-baseline gap-2">
                    <span className="text-xl font-bold text-green-700 dark:text-green-300">AED 15</span>
              ...
              <div className="space-y-3 p-4 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                ...
                <div className="space-y-1.5 text-sm">
                  <div className="flex items-baseline gap-2">
                    <span className="text-xl font-bold text-blue-700 dark:text-blue-300">AED 35</span>
              ...
              <div className="space-y-3 p-4 bg-purple-50 dark:bg-purple-950/20 border border-purple-200 dark:border-purple-800 rounded-lg">
                ...
                <div className="space-y-1.5 text-sm">
                  <div className="flex items-baseline gap-2">
                    <span className="text-xl font-bold text-purple-700 dark:text-purple-300">AED 60</span>
                ...
                <div className="flex gap-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <ul className="text-xs text-amber-800 dark:text-amber-200 space-y-0.5">
                      ...
                      <li>• Insurance up to AED 5,000</li>
